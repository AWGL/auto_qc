...
class TSO500_demultiplex:
	...
	def __init__(self,
				...
				min_fastq_size=1000000,
				ntc_patterns = ['NTC', 'ntc'],
				run_complete_marker = 'FastqGeneration*.stderr'):
	...
	def demultiplex_run_is_complete(self):
		...
		fastq_data_path = results_path.joinpath('Demultiplex_Output/Log_Intermediates/FastqGeneration/')

		marker = fastq_data_path.glob(self.run_complete_marker)
	...
	def demultiplex_run_is_valid(self):
		...
		for sample in self.sample_names:
			...
			fastq_data_path = fastq_data_path.joinpath(sample)
